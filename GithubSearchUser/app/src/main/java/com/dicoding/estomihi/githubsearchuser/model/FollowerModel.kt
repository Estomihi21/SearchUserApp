...
class FollowerModel : ViewModel() {
    ...
    val dataUser = MutableLiveData<ArrayList<followersdata>>()

    fun setFollowersUser(username: String) {
        val listData = ArrayList<followersdata>()
            ...
            override fun onSuccess(statusCode: Int, headers: Array<out Header>?,
                ...
                try {
                    ...
                    for (i in 0 until responseArray.length()) {
                        ...
                        val dataUser =followersdata()
                        dataUser.id = followers.getInt("id")
    ...
    fun getFollowersUser(): LiveData<ArrayList<followersdata>> {
        return dataUser
    }
}
